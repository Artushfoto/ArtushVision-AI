...
Skip the manual spreadsheet work. The FTP module is deeply integrated with a powerful [Category Matrix](/docs/settings-configuration-customization.htmlmd#the-category-matrix.html) that translates your internal organization into agency-specific requirements.
