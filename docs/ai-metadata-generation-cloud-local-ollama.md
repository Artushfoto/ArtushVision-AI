...
Best for maximum speed and complex commercial SEO. Connect your [OpenRouter API key](/docs/cloud-ai-openrouter-api-setup.md) to access elite models such as Google Gemini 2.0 Flash, Claude 3.5 Sonnet, or GPT-4o.
...
Best for 100% privacy, non-disclosure agreement (NDA) shoots, and zero API costs. The application integrates directly with your local [Ollama](/docs/ollama-installation-guide.md) installation (see our [Setup Guide](/docs/ollama-installation-guide.md) if you haven't installed it yet).
...
[IMAGE: A close-up of the Language and AI settings tab, highlighting the AI Engine dropdown, [Ollama](/docs/ollama-installation-guide.md) configuration, and VRAM context limits.]
...
* **Smart Geolocation:** GPS coordinates are translated via [OpenStreetMap or ArcGIS](/docs/settings-configuration-customization.md#maps-and-reverse-geocoding) into City and Country names, allowing the AI to include specific location context automatically.
* **Global AI Hint:** Input a specific fact—such as a Latin species name—into the [Global Hint](/docs/advanced-ai-prompting-profiles-variables.md#basic-and-contextual-variables) field. The AI treats this as an absolute fact and prioritizes it in the generated metadata.
* **[Category Matrix](/docs/settings-configuration-customization.md#the-category-matrix) Integration:** The engine ensures generated keywords align with your selected commercial [Master Categories](/docs/settings-configuration-customization.md#the-category-matrix).
