...
[IMAGE: A close-up of the Language and AI settings tab, highlighting the AI Engine dropdown, [Ollama](ollama-installation-guide.md) configuration, and VRAM context limits.]
