...
* **API Configuration:** Test your connection to OpenRouter (Cloud AI) or your local Ollama installation (Local AI) to ensure prompts and models respond as expected.
* **Workflow Integration:** Experiment with the Category Matrix, FTP Profiles, and CSV generation to confirm the software perfectly aligns with your specific microstock distribution needs.
