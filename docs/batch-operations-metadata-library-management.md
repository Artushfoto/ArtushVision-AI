...
* **Selection Tools:** Use standard keyboard shortcuts (Shift+Click for ranges, Ctrl+A for all) to define the scope of your batch operation instantly.
  ...
  **Using Smart Filters in ArtushVision AI**
  ...
  <p><a href="video/smart-filters.mp4" target="_blank" style="font-size: 0.9em;">Watch tutorial: How to use Smart Filters in ArtushVision AI (full size)</a></p>
...
<p><a href="video/batch-operations.mp4" target="_blank" style="font-size: 0.9em;">Watch tutorial: How to use Batch Operations and Bulk Text Replacement (full size)</a></p>
