...
* **[Smart Protection](docs/smart-manual-keywording-batch-editing.md#smart-batch-editing-and-copy-paste):** AI appends insights without overwriting your manual keywords or Face Tags.
* **[Getty Optimizer](docs/getty-images-esp-metadata-optimizer.md#getty-images-optimizer-master-esp-tool):** 100% submission success with Master Dictionary validation.
* **[Smart FTP](docs/global-stock-distribution-ftp.md#multi-server-smart-ftp):** "Zero-touch" workflow with [automated CSV generation](docs/global-stock-distribution-ftp.md#automated-csv-generation).
...
* **[Cloud AI](docs/ai-metadata-generation-cloud-local-ollama.md#cloud-ai-fast-and-maximum-intelligence) (Fast & Maximum Intelligence):** Uses top-tier models via [OpenRouter](docs/cloud-ai-openrouter-api-setup.md). Process up to **150,000 photos for just $5** with ultra-low API costs.
...
* **[Hybrid AI](docs/ai-metadata-generation-cloud-local-ollama.md#hybrid-ai-local-vision-cloud-description) (Local Vision + Cloud Description):** Phase 1 uses local visual analysis, while Phase 2 utilizes cloud threading for text formatting. **Photos never leave your device; only generated text is sent for SEO processing.**
* **[2-Pass Local AI](docs/ai-metadata-generation-cloud-local-ollama.md#2-pass-local-ai-deep-offline-synthesis) (Deep Offline Synthesis):** The flagship offline workflow.
...
* **[Interactive Getty Resolver](docs/getty-images-esp-metadata-optimizer.md#interactive-getty-resolver):** Batch-validate keywords against a **Master Dictionary of 11,746+ commercial terms**.
...
* **[Automated CSV Metadata](docs/global-stock-distribution-ftp.md#automated-csv-generation):** Eliminates manual spreadsheet work. The app generates agency-specific CSV files on-the-fly and uploads them alongside your media.
...
* **[Persistent Status Tracking](docs/smart-grid-filters-search-metadata-management.md#three-state-ftp-distribution-filter):** Visual **FTP Status Badges** are written **directly into the file's XMP metadata**, ensuring history is never lost even if files are moved.
...
| **Media Privacy** | Mandatory Cloud Upload | **[100% Privacy](docs/local-ai-model-manager-ollama.md)** (Local AI) or Thumbnails only |
...
* **[Ollama](https://ollama.com):** Required for [Local AI analysis](docs/local-ai-model-manager-ollama.md).
...
3. **AI Configuration:** Enter your [OpenRouter API Key](docs/cloud-ai-openrouter-api-setup.md) for Cloud or ensure Ollama is running for the [Local Model Manager](docs/local-ai-model-manager-ollama.md).
...
### [Filter Bar](docs/smart-grid-filters-search-metadata-management.md#precision-search-and-limit-validation)
...
## [3. AI Analysis Workflow](docs/ai-metadata-generation-cloud-local-ollama.md#how-to-generate-metadata-in-3-steps)
...
Use **[Dynamic Variables](docs/advanced-ai-prompting-profiles-variables.md#2-dynamic-variables-reference)** to feed the AI technical data hidden in your files.
...
| **Current Geodata**| `{city}` / `{country}` | [Live GPS location data](docs/advanced-ai-prompting-profiles-variables.md#2-geolocation-variables-automatic) | `"Paris", "France"` |
| | `{text_ocr}` | Text extracted visually from image | `"Route 66"` |
| **Technical EXIF** | `{camera_model}` | [Camera or Drone model](docs/advanced-ai-prompting-profiles-variables.md#3-technical-and-exif-parameters) | `"Sony A7IV"` |
...
* **The Editor:** Features real-time word counters and **[Multilingual Spell Check](docs/smart-manual-keywording-batch-editing.md#multi-language-spellcheck-and-auto-corrections)** (right-click for suggestions).
* **[Keyword Bubbles](docs/smart-manual-keywording-batch-editing.md#visual-tag-bubbles-and-seamless-drag-and-drop):** Drag and drop to reorder. 🔵 (AI), 🟢 (Manual), ⚫ (Original).
* **Linguistic Tools:** Right-click a bubble for **[Synonyms](docs/smart-manual-keywording-batch-editing.md#interactive-synonym-explorer)** (Datamuse) or view native Translation Tooltips.
* **[Interactive Map](docs/settings-configuration-customization.md#maps-and-reverse-geocoding):** View exact GPS locations with zoom and satellite support.
