...
* **[Persistent Status Tracking](docs/global-stock-distribution-ftp.md#advanced-tracking-and-visual-status-badges):** Visual **FTP Status Badges** are written **directly into the file's XMP metadata**, ensuring history is never lost even if files are moved.
...
### Top Toolbar
* **[Profile](docs/advanced-ai-prompting-profiles-variables.md#4-profile-management-and-workflows):** Select [AI prompts](docs/advanced-ai-prompting-profiles-variables.md) (e.g., "Stock Photography"). Click the **Gear icon** to customize.
* **Run AI:** The **green play button** starts analysis for all selected images.
* **Absolute Priority AI Hint:** Treats [manual user hints](docs/advanced-ai-prompting-profiles-variables.md#basic-and-contextual-variables) (e.g., Latin names) as unquestionable facts.
